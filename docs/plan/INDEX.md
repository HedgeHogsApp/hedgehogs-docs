...
| [`2026-09-18-colosseum-3-chains.md`](./2026-09-18-colosseum-3-chains.md) | The Colosseum Crypto World's Fair hackathon plan — strategy, the 3 EVM chains to add (Arbitrum / HyperEVM / Robinhood Chain), what already exists per chain, the repo-by-repo implementation (contracts → bot → indexer → prices → frontend → UI/UX), optimisation, the 24-day roadmap, and the executable tickets (T1–T22). Owner-approved. |
